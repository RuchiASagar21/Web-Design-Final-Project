...
const TimelineSelector = (props) =>{
    ...
    return(
        <Grid container className="timeline-selector-main" justifyContent={'left'}>
            <Grid item  display={"flex"} direction={"row"} justifyContent={'left'} className={"timeline-selector-div"}>
